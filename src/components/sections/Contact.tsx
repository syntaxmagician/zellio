              ...
              <AnimatePresence>
                ...
                {isSending && (
                  ...
                  >
                    ...
                    <p className="text-xl font-black text-slate-900 mb-2">Sending secure message...</p>
                ...
                {sendResult === "success" && (
                  ...
                  >
                    ...
                    <p className="text-2xl font-black text-slate-900 mb-3">Email Sent Successfully!</p>
                ...
                {sendResult === "error" && (
                  ...
                  >
                    ...
                    <p className="text-2xl font-black text-slate-900 mb-3">Gateway Timeout</p>
