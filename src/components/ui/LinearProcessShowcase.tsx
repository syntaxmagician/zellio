...
export default function LinearProcessShowcase() {
  return (
    <div
      className="w-full bg-[#08090A] border border-white/5 rounded-2xl overflow-hidden shadow-2xl font-sans text-xs text-[#C4C8D0]"
      aria-hidden="true"
      role="presentation"
    >
      {/* Top Window Bar */}
      <div className="h-10 border-b border-white/5 bg-[#0D0E10] px-4 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-mono tracking-wider text-white/70">zellio-engine-v2</span>
        </div>
        <div className="flex items-center gap-3">
          <span className="text-[9px] font-mono text-emerald-400 bg-emerald-500/5 px-2 py-0.5 rounded border border-emerald-500/10">STABLE PRODUCTION</span>
        </div>
      </div>
        ...
        <div className="w-48 bg-[#0D0E10] border-r border-white/5 p-4 flex flex-col justify-between shrink-0 hidden sm:flex">
          <div className="space-y-6">
            ...
            <div className="space-y-1">
              <span className="text-[8px] font-bold text-white/60 uppercase tracking-widest px-2 block mb-2">ENGINEERING OS</span>
          ...
          <div className="flex items-center gap-2 border-t border-white/5 pt-3 px-1.5">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] text-white/60 font-mono">v2.4.0-stable</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-grow p-4 sm:p-5 bg-[#08090A] flex gap-4 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-6">
          ...
          <div className="flex flex-col gap-3 w-[260px] shrink-0 snap-start">
            <div className="flex items-center justify-between border-b border-white/5 pb-2">
              ...
              <span className="text-[10px] bg-white/5 px-1.5 py-0.5 rounded font-mono text-white/70">1</span>
            </div>
            ...
            <div className="bg-[#121315]/80 border border-white/5 p-3 rounded-lg hover:border-white/10 transition-colors space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[8px] text-white/60 flex items-center gap-1"><Clock size={9} /> High Priority</span>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-white/5 pt-2 text-[9px] text-white/70">
          ...
          <div className="flex flex-col gap-3 w-[260px] shrink-0 snap-start">
            <div className="flex items-center justify-between border-b border-white/5 pb-2">
              ...
              <span className="text-[10px] bg-white/5 px-1.5 py-0.5 rounded font-mono text-white/70">2</span>
            </div>
            ...
            <div className="bg-[#121315]/80 border border-white/5 p-3 rounded-lg hover:border-white/10 transition-colors space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[8px] text-white/60 flex items-center gap-1"><Play size={9} /> Active</span>
              </div>
              <p className="text-white/80 font-medium leading-relaxed text-[11px]">
            ...
            <div className="bg-[#0D0E10] border border-white/5 rounded-md p-2 font-mono text-[9px] text-white/70">
              <div className="flex items-center gap-1 mb-1"><Terminal size={9} /> <span>build_runner</span></div>
              <div className="text-emerald-400">$ next build</div>
          ...
          <div className="flex flex-col gap-3 w-[260px] shrink-0 snap-start">
            ...
            <div className="bg-[#121315]/80 border border-white/5 p-3 rounded-lg hover:border-white/10 transition-colors space-y-3 opacity-60">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[8px] text-white/60 flex items-center gap-1"><ArrowRight size={9} /> Released</span>
              </div>
              <p className="text-white/80 font-medium leading-relaxed text-[11px]">
